...
<body>
<table style="width:150%;" class="mgarrtable">
<!--    $query_priority1 = "SELECT Main.ID, Main.PID, Extra_Reqs.Extra_Requirements,
Passengers.PassengerIDCard, Main.Mgarr_Date_of_travel_from, Main.Mgarr_Specific_Trip_1,
 Main.Mgarr_Date_of_travel_to, Main.Mgarr_Specific_Trip_2, Main.Cirkewwa_Date_of_travel_to, Main.Cirkewwa_Specific_Trip_1,
  Main.Cirkewwa_Date_of_travel_from, Main.Cirkewwa_Specific_Trip_2
-->
    <tr>
        <th><h2>ID</h2></th>
        <th><h2>PID</h2></th>
    ...
    while (($row = sqlsrv_fetch_array($rowSQL))!=NULL){
        ...
        echo "<tr><td style='text-align:center;'>" . $row['ID'] . "</td><td style='text-align:center;'>" . $row['PID'] . "</td><td style='text-align:center;'>"
            . $row['Extra_Requirements'] . "</td><td style='text-align:center;'>" . $row['Reason'] . "</td><td style='text-align:center;'>  $temp  </td><td style='text-align:center;'>  $temp2  </td><td style='text-align:center;'>  $temp3  </td>
<td style='text-align:center;'>  $temp4  </td><td style='text-align:center;'>  $temp5  </td><td style='text-align:center;'>  $temp6  </td><td style='text-align:center;'>  $temp7  </td>

    ...
    <body class="body-background-style">
        ...
        VALUES($highest, '$idcard', '$name', '$number');";
                ...
                if(checkName($idcard, $name, $conn)==false){
                    ...
                    echo "<h2 class='mainSubtitleTextStyle'>Update passenger's name with id no. " . $idcard . " from " . $oldname . " to " . $name . " in database?</h2>
                    ...
                    <input type='submit' form='form1' value='Update Name' class='btn-gozoChannel'>
                    </form>";
                } else{
                    $oldname = NULL;
                }
                        ...
                        if ($oldnumber != $number && $number != NULL) {
                            ...
                            <input type='submit' form='form2' value='Update Contact Number' class='btn-gozoChannel'>
                                    ...
                                    if($changes[0] == true && $changes[1] == true){
                                        echo "<h2 class='issueTitleTextStyle'>Update both name and contact number?</h2>
                            ...
                            <input type='hidden' value=" . $name . " id='name' name='name'>
                            <input type='hidden' value=" . $idcard . " id='idcard' name='idcard'> 
                            <input type='submit' value='Update Both' form='form3' class='btn-gozoChannel'>
                            </form>";
                }
            }
            ...
            <input type='submit' form='form4' value='View Remark' class='btn-gozoChannel' style='margin: 0 auto;'>
            </form>";
            //START OF VEHICLE DB
